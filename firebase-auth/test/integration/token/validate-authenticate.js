module.exports = createAuthenticateValidator;

const assert = require(`assert`);
const uuid = require(`uuid`);

async function createAuthenticateValidator(resolvers, source, context, info, tenantId) {
    ...
    try {
        ...
        const tokenData = await resolvers.authenticate(source, {
            input: {
                email,
                password,
                tenantId
