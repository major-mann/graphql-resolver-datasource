...
async function createListValidator(resolvers, source, context, info) {
    ...
    try {
        ...
        // Check no args
        const results1 = await resolvers.list(source, {}, context, info);
        assert.equal(results1.edges.length, 4);
        assert.equal(results1.edges[0].node.entertainerId, `clint-eastwood`);
        assert.equal(results1.edges[1].node.entertainerId, `morgan-freeman`);
        assert.equal(results1.edges[2].node.entertainerId, `michael-cain`);
        assert.equal(results1.edges[3].node.entertainerId, `leonardo-dicaprio`);
        ...
        assert.equal(results2.edges[0].node.entertainerId, `morgan-freeman`);
        assert.equal(results2.edges[1].node.entertainerId, `michael-cain`);
        assert.equal(results2.edges[2].node.entertainerId, `leonardo-dicaprio`);
        ...
        assert.equal(results3.edges[1].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results4.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results5.edges[1].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results6.edges[1].node.entertainerId, `leonardo-dicaprio`);
        ...
        assert.equal(results7.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results8.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results9.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results10.edges[1].node.entertainerId, `leonardo-dicaprio`);
        ...
        assert.equal(results11.edges[1].node.entertainerId, `leonardo-dicaprio`);
        ...
        assert.equal(results12.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results13.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results14.edges[0].node.entertainerId, `morgan-freeman`);
        ...
        assert.equal(results16.edges[0].node.entertainerId, `morgan-freeman`);
        result = true;
    } catch (ex) {
